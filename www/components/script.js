...
function inicioJogo(){
  areaJogo.start();
  personagemObj = new componente("#87CEFA",10,100,30,30);
  pontos = new componente("#4682B4", 10,30,'Consolas','30px', 'texto');
  ...
  for(i = 0; i < obstaculo.length; i++){
   if(personagemObj.bater(obstaculo[i])){
    ...
    if(areaJogo.frame == 1 || contarIntervalo(150)){
      ...
      obstaculo.push(new componente('#191970',x,0,altura,10));
      obstaculo.push(new componente('#191970',x,altura + vazio,x - altura - vazio,10));
    }
